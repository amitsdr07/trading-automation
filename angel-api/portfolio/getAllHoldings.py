...
def get_portfolio(jwt_token: str, api_key: str) -> str:
    ...
    conn.request("GET", "/rest/secure/angelbroking/portfolio/v1/getAllHolding", payload, headers)
...
if __name__ == "__main__":
    try:
        ...
        print(jwt_token)
        portfolio = get_portfolio(jwt_token, api_key)
        print(portfolio)
